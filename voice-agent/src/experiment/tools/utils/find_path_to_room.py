"""Helpers for the find_path_to_room tool: curated directions table,
room-string normalisation, FelSight floor lookup, and prose rendering.

The actual `@function_tool` lives in
voice-agent/src/experiment/tools/find_path_to_room.py — it imports the
...
from ._common import _VOICE_AGENT_DIR  # noqa: F401  (path-glue side effect)
