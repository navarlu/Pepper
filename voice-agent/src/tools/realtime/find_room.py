...
room in the building. Slim wrapper: same curated table + FelSight
floor fallback as the cascade tool (`tools/find_path_to_room.py`), minus the cascade-only
...
from tools.utils._room_directions import (
    ROOM_DIRECTIONS,
    _normalize_room,
    _query_floor,
    _render_curated,
