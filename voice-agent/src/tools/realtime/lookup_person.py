"""lookup_person tool — staff-directory search for the realtime agent.

Slim sibling of `tools/lookup_person.py`: same UDB
...
from tools.utils._events import (
    _emit_tool_event,
    _emit_tool_result,
)
from tools.utils._person import _slim_match
from tools.utils._person_lookup import (
