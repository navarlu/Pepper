...
\NewDocumentEnvironment{ onecolumnfrontmatterpage } { } {
...
\cs_new:Nx \ctuthesis_geometry_hmarginratio: {23\string :27} % 23 27 UP

% Target textwidth is 33*basesize (10pt to 12pt)
\dim_const:Nn \g_ctuthesis_geometry_textwidth_dim { \tl_use:N \g_ctuthesis_fontsize_tl * 39 } %39 UP
...
% UP
\titleformat \chapter [ctuch] {\huge} {{\LARGE\chaptertitlename\ }\thechapter} {-0\dp\strutbox} {\LARGE} [15pt]
...
\captionsetup[subfigure]{format=mysubformat,indent=0pt,labelsep=none,justification=myjustify,font={small},position=below}
