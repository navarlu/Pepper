...
\ctutemplateset{include.declaration}{
	\includepdf[pages=-]{\tl_use:c{ g_ctuthesis_field_declaration-file_tl }}
}
...
\ctutemplateset{maketitle.twocolumn.default}{
        \ctuifswitch{onecolumn-ack}{
        \begin{onecolumnfrontmatterpage}
             \ctutemplate{custom.thanks}
...
\ctutemplateset{maketitle}{
	...
	\ctuifswitch{front-specification}{
        ...
        \ctutemplate{include.declaration}
