...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.85\textwidth]{src/figures/tokens.png}
...
\begin{itemize}
    ...
    \item \textbf{Non-determinism:} Due to probabilistic sampling and internal stochasticity, outputs may vary across runs. The variability can be reduced through the temperature parameter but not eliminated. For some uses, such as creative writing, the variability is welcome.
