...
For a receptionist this is a big shift: a visitor can simply ask a question instead of choosing from a menu, and the robot can ground its reply in institutional information rather than giving a canned response.
...
A human receptionist, of course, still has clear strengths: intuition, social judgement, and the ability to handle situations that the system has not been prepared for.
...
Chapter~\ref{ch:related_work} reviews the related work: large language models and how their behaviour is shaped through prompting, tool calling, and retrieval-augmented generation; speech interfaces for human--robot interaction; the trade-offs between locally hosted and cloud-hosted LLM deployment; and the questionnaires used to evaluate social robots.
